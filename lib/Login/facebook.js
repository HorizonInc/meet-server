...
module.exports = async(app) => {
	...
	app.get("/fb", (req, res) => {
		...
		let redirectObj = { url: `https://www.facebook.com/v3.1/dialog/oauth?client_id=${credentials.ClientId}&redirect_uri=${credentials.redirect_uri}&state=${JSON.stringify(credentials.state)}` };
